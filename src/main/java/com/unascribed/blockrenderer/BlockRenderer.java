...
public class BlockRenderer {
	...
	private String render(ItemStack is, File folder, boolean includeDateInFilename) {
		Minecraft mc = Minecraft.getMinecraft();
		ResourceLocation modid=Item.REGISTRY.getNameForObject(is.getItem());
		String modname=modid.getResourceDomain();
		folder=new File(folder,modname);
		String filename = modid.getResourcePath()+(is.getHasSubtypes()?"_"+is.getItemDamage():"");
		GlStateManager.pushMatrix();
